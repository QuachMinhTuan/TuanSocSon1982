                            ...
                            <section class="mt-3 mb-3 mx-2">
                                <div class="row">
                                    @if (count($products) > 0)
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-1 card-group">
                                                <div class="card">
                                                    <a href="{{ route('detailproduct', $product->slug_name) }}"
                                                        class="detail-thumb"
                                                        title="{{ Str::of($product->slug_name)->title() }}"> <img
                                        ...
                                        @endforeach
                                    @else
                                        <div class="col-md-12 alert alert-primary text-danger">
                                            Không có sản phẩm hay nội dung nào phù hợp với tiêu chí tìm kiếm
                                        </div>
