        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('update_cat_parent_cat_product',$catparent->id) }}" method="GET">
                            @csrf
                            <div class="form-group">
                                <label for="name">Tên danh mục</label>
                                <input class="form-control" type="text" name="catparent" id="name"
                                    value="{{ $catparent->catparent }}">
                                @error('catparent')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <button type="submit" class="btn btn-primary" name="editcatparent">Cập nhật</button>
                        </form>
                    </div>
                </div>
            </div>
