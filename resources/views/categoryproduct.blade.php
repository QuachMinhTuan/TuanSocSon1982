            ...
            <div id="header-bootstrap" class="container-fluid fixed-top ">
                <div class="row no-gutters">
                    <div class="col-md-2 col-sm-2 col-2 py-2 text-center">
                        <a href="{{route('index')}}" id="Logo"><img src="{{asset('public/image/logo.png')  }}" alt="Logo"
                                class="img-fluid"></a>
                    </div>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="container-fluid">
                                    <section class="mt-3 mb-3 mx-2">
                                        <a href="{{route('categoryproduct',$productcatcategory->slug)}}" class="category" title="{{Str::of($productcatcategory->slug)->title()  }}">{{ str::upper($productcatcategory->catname) }}</a>
                                        <div class="row">
